...
[InitializeAtRuntime]
public class MiniGameManager : IMiniGameService
{
    public virtual MiniGameConfiguration Configuration { get; }
    ...
    public MiniGameManager(MiniGameConfiguration config, IUIManager uiManager)
    {
